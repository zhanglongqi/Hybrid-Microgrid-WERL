...
class Mainpv(QWidget, Ui_pvControl):
    ...
    def __init__(self):  # initialisation, passing parameter during the intial state
        ...
        self.mppt_chnl2_on_off.clicked.connect(
            self.mppt_chnl2_on_off_clicked)  # Bind the event handlers to button

        # Event handlers for MPPT Chnl 3
        self.mppt_chnl3_on_off.clicked.connect(
            self.mppt_chnl3_on_off_clicked)  # Bind the event handlers to button
