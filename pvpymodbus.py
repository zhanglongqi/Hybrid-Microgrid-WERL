...
class pv():
    def pv2_array(self):
        ...
        if ((
                self.PV2_Coils_R & 128) == 0):  # check for 8th bits in PV2_Coils_R- Register 11038, coil 7 - MPPT_2_Coil_15
            self.MPPT_2_Coil_15 = 0
        elif ((self.PV2_Coils_R & 128) == 128):
            self.MPPT_2_Coil_15 = 1

        if ((
                self.PV2_Coils_R & 256) == 0):  # check for 9th bits in PV2_Coils_R- Register 11038, coil 8 - MPPT_2_Coil_16
    ...
    def pv3_array(self):
        ...
        if ((
                self.PV3_Coils_R & 128) == 0):  # check for 4th bits in PV3_Coils_R- Register 11058, coil 7 - MPPT_3_Coil_15
            self.MPPT_3_Coil_15 = 0
        elif ((self.PV3_Coils_R & 128) == 128):
            self.MPPT_3_Coil_15 = 1

        if ((
                self.PV3_Coils_R & 256) == 0):  # check for 9th bits in PV3_Coils_R- Register 11058, coil 8 - MPPT_2_Coil_16
