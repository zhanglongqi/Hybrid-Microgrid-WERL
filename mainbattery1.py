...
class Mainbattery1(QWidget, Ui_battery1Control):
    ...
    def batt1_apply_current_pb_clicked(self):
        ...
        client.write_register(970, int(
            Bat_1_Ref_Current_Write_Unit))  # Write to reg 970 - Bat_1_Ref_Current_Write_Unit
    ...
    def batt1_apply_voltage_pb_clicked(self):
        ...
        client.write_register(966, int(
            Bat_1_Ref_Voltage_Write_Unit))  # Write to reg 966 - Bat_1_Ref_Voltage_Write_Unit
